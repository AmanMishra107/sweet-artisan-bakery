...
('Basic Sweet Plan', 'basic', 299, 'Perfect for occasional sweet cravings', '["5% discount on all orders", "Free delivery on orders above ₹500", "Monthly newsletter with recipes", "Priority customer support"]'),
